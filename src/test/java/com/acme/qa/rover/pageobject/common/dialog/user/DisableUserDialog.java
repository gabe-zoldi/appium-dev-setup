 ...
 */
public class DisableUserDialog extends PageObject {
    ...
    public class Expected {
        public class QUESTION {
            public static final String CONFIRM = "Do you really want to disable user %s (%s)?";
        }
    }
    ...
    /* verify                                                                                       */
    /* -------------------------------------------------------------------------------------------- */
    public void verifyQuestion(User user) {
        delay(500);
        String actual = QuestionText().getText();
        String expected = String.format(Expected.QUESTION.CONFIRM, user.getName(), user.getEmail());
    ...
    private WebElement _dialog() {
        return findElement( By.id("disableUserModal") );
    }
